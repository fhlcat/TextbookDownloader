module TextbookDownloaderCli.ParseFolders
...
let rec private ofTagAndBook (tagName: string, books_: BookInfoWithTag seq) =
    ...
    let children =
        if Seq.isEmpty booksWithFirstTagSkippedAndTagsNotEmpty then
            ...
            let folderChildren = lazy mapFolder booksWithFirstTagSkippedAndTagsNotEmpty
...
and mapFolder (books: BookInfoWithTag seq) =
